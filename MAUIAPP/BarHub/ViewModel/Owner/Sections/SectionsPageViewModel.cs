...
{
    public partial class SectionsPageViewModel : ObservableObject
    {
        [ObservableProperty]
        ...
        public SectionsPageViewModel(Gets gets, Deletes deletes, Puts puts, Posts posts, User user, IContext<SectionViewModel> sectionContext)
        {
        ...
        private void SetActions(IContext<SectionViewModel> sectionContext, Gets gets, Deletes deletes, Puts puts, Posts posts, User user)
        {
            ...
            {
                await puts.ModifySection(section.ToModel());
